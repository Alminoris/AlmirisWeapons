...
public class ModItems
{
    ...
    static
    {
        ...
        for(String name : WeaponSetsHelper.MATERIALS)
        {
            ...
            DANE_AXES.put(name, registerItem(name+"_dane_axe", new SwordItem(TOOL_MATERIALS.get(name),
                    7, -3.2f, new Item.Settings().maxCount(1).group(ModItemGroups.ALMIRIS_WEAPONS_TAB))));

            BEARDED_AXES.put(name, registerItem(name+"_bearded_axe", new SwordItem(TOOL_MATERIALS.get(name),
