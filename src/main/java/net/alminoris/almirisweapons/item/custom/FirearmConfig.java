        ...
        int flameCount)
{
    public static class Builder
    {
        ...
        private ParticleEffect reloadParticle, smokeParticle, flameParticle;
        private int reloadParticleCount = 0, smokeCount = 0, flameCount = 0;
        private double smokeSpread = 0, smokeSpeed = 0;

        public Builder useAction(UseAction val) { this.useAction = val; return this; }
        ...
        public Builder reloadParticle(ParticleEffect val) { this.reloadParticle = val; return this; }
        public Builder reloadParticleCount(int val) { this.reloadParticleCount = val; return this; }
        public Builder smokeParticle(ParticleEffect val) { this.smokeParticle = val; return this; }
