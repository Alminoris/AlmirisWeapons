...
public abstract class AbstractFirearmItem extends Item
{
    ...
    private void fire(World world, PlayerEntity player, ItemStack stack, Hand hand)
    {
        ...
        {
            player.sendMessage(new TranslatableText("message.almirisweapons.misfire"), true);
        ...
        {
            player.sendMessage(new TranslatableText("message.almirisweapons.no_ammo"), true);
            return;
        }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context)
    {
        ...
        tooltip.add(new LiteralText(" ")
                .append(new LiteralText(cfg.damage() + " ").formatted(Formatting.DARK_GREEN))
                .append(new TranslatableText("tooltip.almirisweapons.damage")
                        .formatted(Formatting.DARK_GREEN)));

        tooltip.add(new LiteralText(" ")
                .append(new LiteralText((cfg.reloadTicks() / 20f) + "s ").formatted(Formatting.DARK_GREEN))
                .append(new TranslatableText("tooltip.almirisweapons.reload_time")
                        .formatted(Formatting.DARK_GREEN)));

        tooltip.add(new LiteralText(" ")
                .append(new LiteralText(cfg.ammoPerShot() + " ").formatted(Formatting.DARK_GREEN))
                .append(new TranslatableText("tooltip.almirisweapons.ammo_per_shot")
                        .formatted(Formatting.DARK_GREEN)));

        tooltip.add(new LiteralText(" ")
                .append(new LiteralText((int)(cfg.misfireChance() * 100) + "% ").formatted(Formatting.DARK_GREEN))
                .append(new TranslatableText("tooltip.almirisweapons.misfire")
                        .formatted(Formatting.DARK_GREEN)));
