...
public class ModRecipeProvider extends FabricRecipeProvider
{
    ...
    {
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("wood"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("stone"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("iron"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("gold"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("diamond"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
                .input('#', Items.DIAMOND)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BATTLE_STAVES.get("netherite"), 1)
                .pattern("  #")
                .pattern(" / ")
                .pattern("#  ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.STABBING_TIPS.get("wood"), 3)
                .pattern("/")
                .pattern("/")
                .pattern("/")
                .input('/', ItemTags.PLANKS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.AXE_TIPS.get("wood"), 3)
                .pattern("/  ")
                .pattern("///")
                .pattern("/  ")
                .input('/', ItemTags.PLANKS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.MACE_TIPS.get("wood"), 3)
                .pattern(" / ")
                .pattern("///")
                .pattern(" / ")
                .input('/', ItemTags.PLANKS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.SINGLEEDGE_BLADES.get("wood"), 3)
                .pattern("  /")
                .pattern(" / ")
                .pattern("/  ")
                .input('/', ItemTags.PLANKS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.CURVED_BLADES.get("wood"), 3)
                .pattern(" /")
                .pattern("/ ")
                .pattern(" /")
                .input('/', ItemTags.PLANKS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.STABBING_TIPS.get("stone"), 3)
                .pattern("/")
                .pattern("/")
                .pattern("/")
                .input('/', ItemTags.STONE_TOOL_MATERIALS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.AXE_TIPS.get("stone"), 3)
                .pattern("/  ")
                .pattern("///")
                .pattern("/  ")
                .input('/', ItemTags.STONE_TOOL_MATERIALS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.MACE_TIPS.get("stone"), 3)
                .pattern(" / ")
                .pattern("///")
                .pattern(" / ")
                .input('/', ItemTags.STONE_TOOL_MATERIALS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.SINGLEEDGE_BLADES.get("stone"), 3)
                .pattern("  /")
                .pattern(" / ")
                .pattern("/  ")
                .input('/', ItemTags.STONE_TOOL_MATERIALS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.CURVED_BLADES.get("stone"), 3)
                .pattern(" /")
                .pattern("/ ")
                .pattern(" /")
                .input('/', ItemTags.STONE_TOOL_MATERIALS)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.PISTOL_BARREL, 1)
                .pattern("  #")
                .pattern("*/ ")
                .input('#', Items.IRON_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BLUNDERBUSS_BARREL, 1)
                .pattern("  #")
                .pattern("*# ")
                .pattern("*  ")
                .input('#', Items.IRON_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.ARQUEBUS_BARREL, 1)
                .pattern("  #")
                .pattern("*/ ")
                .pattern("#  ")
                .input('#', Items.IRON_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.MATCHLOCK_MECHANISM, 1)
                .pattern("*  ")
                .pattern("***")
                .pattern("* *")
                .input('*', Items.IRON_NUGGET)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.GUN_STOCK, 1)
                .pattern(" #*")
                .pattern("#* ")
                .pattern("#  ")
                .input('#', Items.STICK)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BULLET, 2)
                .pattern(" * ")
                .pattern("*#*")
                .pattern(" * ")
                .input('#', Items.IRON_INGOT)
        ...
        for (String name : MATERIALS)
        {
            ...
            {
                ShapedRecipeJsonBuilder.create(ModItems.STABBING_TIPS.get(name), 3)
                        .pattern("/")
                        .pattern("/")
                        .pattern("/")
                ...
                ShapedRecipeJsonBuilder.create(ModItems.AXE_TIPS.get(name), 3)
                        .pattern("/  ")
                        .pattern("///")
                        .pattern("/  ")
                        .input('/', ModItems.MATERIAL_ITEMS.get(name))
                ...
                ShapedRecipeJsonBuilder.create(ModItems.MACE_TIPS.get(name), 3)
                        .pattern(" / ")
                        .pattern("///")
                        .pattern(" / ")
                        .input('/', ModItems.MATERIAL_ITEMS.get(name))
                ...
                ShapedRecipeJsonBuilder.create(ModItems.SINGLEEDGE_BLADES.get(name), 3)
                        .pattern("  /")
                        .pattern(" / ")
                        .pattern("/  ")
                        .input('/', ModItems.MATERIAL_ITEMS.get(name))
                ...
                ShapedRecipeJsonBuilder.create(ModItems.CURVED_BLADES.get(name), 3)
                        .pattern(" /")
                        .pattern("/ ")
                        .pattern(" /")
                        .input('/', ModItems.MATERIAL_ITEMS.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.DOUBLEEDGE_BLADES.get(name), 1)
                    .pattern("//")
            ...
            ShapedRecipeJsonBuilder.create(ModItems.HALBERDS.get(name), 1)
                    .pattern(" #*")
                    .pattern(" / ")
                    .pattern("/  ")
            ...
            ShapedRecipeJsonBuilder.create(ModItems.GLAIVES.get(name), 1)
                    .pattern("  #")
                    .pattern(" / ")
                    .pattern("/  ")
                    .input('#', ModItems.SINGLEEDGE_BLADES.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.SCYTHES.get(name), 1)
                    .pattern("###")
                    .pattern(" / ")
                    .pattern("/  ")
            ...
            ShapedRecipeJsonBuilder.create(ModItems.RAPIERS.get(name), 1)
                    .pattern("  #")
                    .pattern(" # ")
                    .pattern("/  ")
                    .input('#', ModItems.STABBING_TIPS.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.KATANAS.get(name), 1)
                    .pattern("#  ")
                    .pattern(" # ")
                    .pattern("  /")
                    .input('#', ModItems.SINGLEEDGE_BLADES.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.BATTLE_AXES.get(name), 1)
                    .pattern("#/#")
                    .pattern(" / ")
                    .input('#', ModItems.AXE_TIPS.get(name))
                    .input('/', ModItems.SMALL_STICK)
            ...
            ShapedRecipeJsonBuilder.create(ModItems.KATARS.get(name), 1)
                    .pattern(" # ")
                    .pattern("/#/")
                    .pattern("/ /")
                    .input('#', ModItems.STABBING_TIPS.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.DANE_AXES.get(name), 1)
                    .pattern("## ")
                    .pattern("##/")
                    .pattern("  /")
                    .input('#', ModItems.AXE_TIPS.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.BEARDED_AXES.get(name), 1)
                    .pattern("## ")
                    .pattern("# /")
                    .pattern("  /")
                    .input('#', ModItems.AXE_TIPS.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.SAI.get(name), 1)
                    .pattern("##")
                    .pattern("/#")
                    .input('#', ModItems.STABBING_TIPS.get(name))
                    .input('/', ModItems.SMALL_STICK)
            ...
            ShapedRecipeJsonBuilder.create(ModItems.DAGGERS.get(name), 1)
                    .pattern(" #")
                    .pattern("/ ")
                    .input('#', ModItems.CURVED_BLADES.get(name))
                    .input('/', ModItems.SMALL_STICK)
            ...
            ShapedRecipeJsonBuilder.create(ModItems.ODACHIS.get(name), 1)
                    .pattern("*  ")
                    .pattern(" # ")
                    .pattern("  /")
                    .input('*', ModItems.SINGLEEDGE_BLADES.get(name))
            ...
            ShapedRecipeJsonBuilder.create(ModItems.MACES.get(name), 1)
                    .pattern(" #")
                    .pattern("/ ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.ARQUEBUS, 1)
                .pattern("BL ")
                .pattern(" S ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.BLUNDERBUSS, 1)
                .pattern("B ")
                .pattern("L ")
                .pattern("S ")
        ...
        ShapedRecipeJsonBuilder.create(ModItems.MATCHLOCK_PISTOL, 1)
                .pattern("B ")
                .pattern("L ")
                .pattern("S ")
